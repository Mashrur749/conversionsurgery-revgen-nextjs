#!/usr/bin/env bash
# Cleanup script for temporary artifacts — neutral version for Kimi/Claude parity
# Run manually: bash .kimi/scripts/cleanup.sh
# Or automatically via SessionEnd hook
...
# 2. Remove stale progress/log artifacts
