...
/** Calendar events linked to clients, leads, and external calendar providers */
...
/** Inferred select type for calendar_events rows */
export type CalendarEvent = typeof calendarEvents.$inferSelect;

/** Inferred insert type for calendar_events rows */
