...
export STRIPE_WEBHOOK_SECRET="${STRIPE_WEBHOOK_SECRET:-whsec_smoke_placeholder}"
export RESEND_API_KEY="${RESEND_API_KEY:-re_smoke_placeholder}"
export ANTHROPIC_API_KEY="${ANTHROPIC_API_KEY:-smoke-anthropic-key}"
